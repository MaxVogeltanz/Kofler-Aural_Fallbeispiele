<!--XSLT for Fallbeispiel 10 in project "Kofler Aural" (https://gams.uni-graz.at/context:kofleraural)-->
<!--Transforms rdf ontology object o:kofleraural.fallbeispiel10 to HTML (https://gams.uni-graz.at/archive/objects/o:kofleraural.fallbeispiel10/methods/sdef:Ontology/get)-->
        ...
        <nav class="navbar-dark navbar-fixed-bottom" id="bottom_nav">
            <div class="container">
                ...
                <p class="bottomnavp">
                    ...
                    <a
                        href="/archive/objects/o:kofleraural.fallbeispiel10/methods/sdef:Ontology/get?mode=graph"
                        role="button">
                ...
                <p class="bottomnavp">
                    ...
                    <a href="/archive/objects/o:kofleraural.fallbeispiel10/methods/sdef:Ontology/get" role="button">
                ...
                <p class="bottomnavp">
                    ...
                    <a
                        href="/archive/objects/o:kofleraural.fallbeispiel10/methods/sdef:Ontology/get?mode=horizontal"
                        role="button">
                ...
                <p class="bottomnavp">
                    ...
                    <a
                        href="/archive/objects/o:kofleraural.fallbeispiel10/methods/sdef:Ontology/get?mode=morphing"
                        role="button">
                ...
                <p class="bottomnavp">
                   <a
                       href="/archive/objects/o:kofleraural.fallbeispiel10/datastreams/ONTOLOGY/content"
        ...
        <section class="row equalheight">
           ...
           <xsl:when test="$mode = ''">   
             ...
             <article class="col-md-12" style="margin-bottom: 10px; margin-top: 20px;"> 
                    ...
                    <div class="row">
                        <div class="col-md-6"><h3>Fallbeispiel 'Crime-Fragment / Abbruch '</h3>
                            <p>Druck: Am Schreibtisch, 2018, S. 82.</p>
                            <p style="font-size:80%">(11.W7.2: <a style="color:#a48d96" href="{concat($server, '/o:kofleraural.11-W7-2#Mappe1_0082r')}">0082r-0083r</a>)</p>
            ...
            <!-- Visualisierung vertikal // Anordnung der Phrasen und call von Phrasen templates-->
             <article id="fallcontent1" class="col-md-10 fallcontent" style="margin-bottom: 10px; margin-top: 20px; display: block;" >
                <div class="row col-md-12"> 
                 ...
                 <div class="row">                                    
                    <div class="col-md-12">
                        <div><h5 style="font-size: 80%;"><xsl:value-of select="distinct-values(//kofler:Phrase[@rdf:about[. ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A']]/kofler:textType)"/></h5></div>
                        <div class="falldiv1"> <xsl:text> </xsl:text>
                            <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A']"></xsl:apply-templates> 
                        </div>
                 ...
                 <div class="row">    
                    <div class="col-md-12">
                        <div><h5 style="font-size: 80%;"><xsl:value-of select="distinct-values(//kofler:Phrase[@rdf:about[. ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B']]/kofler:textType)"/></h5></div>
                        <div class="falldiv1">
                            <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B']"></xsl:apply-templates> 
                     </div>
                ...
                <div class="row">   
                    <div class="col-md-12">
                        <div><h5 style="font-size: 80%;"><xsl:value-of select="distinct-values(//kofler:Phrase[@rdf:about[. ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C']]/kofler:textType)"/></h5></div>
                        <div class="falldiv1">
                            <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C']"></xsl:apply-templates>
                            </div>
                        <div style="text-align: center;"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1"/>
                        </svg></div>
                  ...
                  <div class="row">   
                    <div class="col-md-12">
                        <div><h5 style="font-size: 80%;"><xsl:value-of select="distinct-values(//kofler:Phrase[@rdf:about[. ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D']]/kofler:textType)"/></h5></div>
                        <div class="falldiv1">
                            <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D']"></xsl:apply-templates>
                            </div>
                        <div style="text-align: center;"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1"/>
                        </svg></div>
                ...
                <div class="row">       
                    <div class="col-md-12">
                        <div><h5 style="font-size: 80%; margin-top: -1rem;">Druckversion</h5></div>
                                            <div class="falldiv1">
                            <xsl:apply-templates select="//kofler:finalPhrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase']"></xsl:apply-templates>
                     </div>
                   ...
                   <div class="col-md-10">
                       ...
                       <div class="horizontal-scroll-wrapper">
                           ...
                           <div class="horizontal">
                               ...
                               <!-- ABCD -->
                               <div> <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A']"></xsl:apply-templates>
                               </div>
                           </div>
                               <div class="horizontal">
                                   <h5 style="font-size: 70%;">TYPOSKRIPT</h5>
                               <div> <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B']"></xsl:apply-templates>
                               </div>
                           </div>
                               <div class="horizontal">
                                   <h5 style="font-size: 70%;">TYPOSKRIPT</h5>
                               <div> <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C']"></xsl:apply-templates>
                               </div>
                           </div>
                               <div class="horizontal">
                                   <h5 style="font-size: 70%;">TYPOSKRIPT VOR DRUCK</h5>
                               <div> <xsl:apply-templates select="//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D']"></xsl:apply-templates>
                               </div>
                           </div>
                           ...
                           <div class="horizontal">
                               ...
                               <!-- Druck -->
                               <div> <xsl:apply-templates select="//kofler:finalPhrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase']"></xsl:apply-templates>
                               </div>
                           </div>
                           </div>
                       </div>
                 ...
                 <div class="col-md-12">
                     ...
                     <div class="col-md-8" style="background-color: #ededed;">
                         ...
                         <div id="satz1" class="divmorph">
                             <span class="morphspan" data-toggle="tooltip" data-placement="top" title="Phrase A. In: 11.W7.3, Blatt: {//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A']/kofler:onPage}">Phrase A: </span><xsl:text> </xsl:text>
                             <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A_')]">
                         ...
                         <div id="satz2" class="divmorph" style="display: none;">
                             <span class="morphspan" data-toggle="tooltip" data-placement="top" title="Phrase B. In: 11.W7.3, Blatt: {//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B']/kofler:onPage}">Phrase B: </span><xsl:text> </xsl:text>
                             <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B_')]">
                             <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
                         </xsl:apply-templates>
                             <xsl:text> </xsl:text> <button class="morph-btn"><xsl:text> </xsl:text></button>
                         </div> 
                         <div id="satz3" class="divmorph" style="display: none;">
                             <span class="morphspan" data-toggle="tooltip" data-placement="top" title="Phrase C. In: 11.W7.3, Blatt: {//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C']/kofler:onPage}">Phrase C: </span><xsl:text> </xsl:text>
                             <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C_')]">
                                 <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
                             </xsl:apply-templates>
                             <xsl:text> </xsl:text> <button class="morph-btn"><xsl:text> </xsl:text></button>
                         </div>
                         <div id="satz4" class="divmorph" style="display: none;">
                             <span class="morphspan" data-toggle="tooltip" data-placement="top" title="Phrase D. In: 11.W7.1, Blatt: {//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D']/kofler:onPage}">Phrase D: </span><xsl:text> </xsl:text>
                             <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D_')]">
                             <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
                         </xsl:apply-templates>
                             <xsl:text> </xsl:text> <button class="morph-btn"><xsl:text> </xsl:text></button>
                         </div>
                         ...
                         <div id="satz5" class="divmorph" style="display: none;">
                             <span class="morphspan" data-toggle="tooltip" data-placement="top" title="Am Schreibtisch, Blatt: {//kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A']/kofler:onPage}">Druck: </span><xsl:text> </xsl:text>
                             <xsl:apply-templates select="//kofler:finalWord[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_fw')]">
                                 <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
                             </xsl:apply-templates>
             ...
             <article id="fallcontent4" class="col-md-12 fallcontent" style="margin-bottom: 10px; margin-top: 20px;">
                <div class="row col-md-12"> 
                    ...
                    <script src="{concat($gamsdev, '/kofleraural/js/graphfall10.js')}"><xsl:text> </xsl:text></script>
                </div>
            </article>
            </xsl:when> 
           </xsl:choose>   
...
<!-- Alle Phrasen templates A-H + finale Phrase  und Wort Templates  -->
    ...
    <!-- Phrase A -->
    <xsl:template match="kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A']">
    ...
    <xsl:template match="kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_A_')]">
    ...
    <!-- Phrase B -->
    <xsl:template match="kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B']">
        <!-- Phrase B -->
        <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B_')]">
            <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
    ...
    <xsl:template match="kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_B_')]">
    ...
    <!-- Phrase C -->
    <xsl:template match="kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C']">
        <!-- Phrase C -->
        <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C_')]">
            <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
    ...
    <xsl:template match="kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_C_')]">
    ...
    <!-- Phrase D -->
    <xsl:template match="kofler:Phrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D']">
        <!-- Phrase D -->
        <xsl:apply-templates select="//kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D_')]">
            <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
    ...
    <xsl:template match="kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_D_')]">
    ...
    <xsl:template match="kofler:Word[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_E_')]">
    ...
    <xsl:template match="kofler:finalPhrase[@rdf:about ='https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase']">
        <xsl:apply-templates select="//kofler:finalWord[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_fw')]">
            <xsl:sort select="kofler:hasConsecutiveNumber" data-type="number" order="ascending" />
        </xsl:apply-templates>
    ...
    <xsl:template match="kofler:finalWord[starts-with(@rdf:about, 'https://gams.uni-graz.at/o:kofleraural.fallbeispiele#AmSchreibtisch_f10_Phrase_fw')]">
